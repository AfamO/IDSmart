...
public class Change_user extends javax.swing.JDialog {
    ...
    //private String user_id;
     private String myid[]=BiometricMain.getmyuserid();
    ...
    public void UpdateInforCaller()
 {
     ...
     }else
     {
        ...
        // Reconsoft2 dat2=new Reconsoft2();
         data.updateAdmin(user, pass, status);
         //dat2.updateAdmin(user, pass, status);
         JOptionPane.showMessageDialog(null, "User Information Updated Successfully");
         InfoLogged=  AppLogger.InfoLogged(AdminLogin.getBiodata[1], AdminLogin.getBiodata[2], "CHANGED LOGGED IN DETILS FOR THE USER WITH USERNAME :"+user);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(vpassTF)
                            .addComponent(passTF)
                            .addComponent(useridTF)
                            .addComponent(staTF, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(82, 82, 82)
                        .addComponent(proB)
                        .addGap(54, 54, 54)
