 ...
 * @author Charles
 */
public class EditStudentNextofKin extends javax.swing.JDialog {
    ...
    public EditStudentNextofKin(String m1,String m2) {
        //super(parent, modal);
        initComponents();
        this.regNo=m1;
        this.newregNo=m2;
       ...
       staffNextkinid=st.QueryStaffNextofKinInformation(regNo);
        staffbioid=st.QueryStaffBioID(regNo);
       ...
       reTF.setText(staffNextkinid.getRelation());
        ...
        kinid=staffNextkinid.getSelectedStudentkinid();
         
         bioid=staffbioid.getSelectedStudentbioid();
   ...
   public void ProcessNextofkinInfo()
    {
       ...
       // Reconsoft2 dat2 = new Reconsoft2();
        data.UpdateEditableStaffNextOfKinsInformation(kinid,newregNo,surname, fname, fone, add, rela);
        data.UpdateEditable_Staff_Bio_Id(bioid, newregNo);
        
       // dat2.UpdateEditableStaffNextOfKinsInformation(kinid,newregNo,surname, fname, fone, add, rela);
       // dat2.UpdateEditable_Staff_Bio_Id(bioid, newregNo);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(titleCB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
