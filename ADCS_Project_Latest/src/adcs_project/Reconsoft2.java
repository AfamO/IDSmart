...
import adcs_project.StaffBasicRegSummary;
import java.awt.*;
...
public class Reconsoft2 {
    //private URL u=new URL("index.html");
    private Statement statement;
    private  Connector2 dbconnector;
    ...
    public Reconsoft2(){
     ...
     public Reconsoft2(String m1,String m2,String m3){
        this.n1=m1;
        this.n2=m2;
        this.n3=m3;
      ...
      public void AddStudentsBasicInfor(String reg,String fname,String mname,String oname,String gen,String fac,String dept,String lev,String sess,String add,String fone,String group,String state,String lga,String bdate){
        ...
        try {
           ...
           statement = dbconnector.dbconn2.createStatement();
...
PreparedStatement stmt = dbconnector.dbconn2.prepareStatement(sql);
...
System.out.println(ex.getMessage());
    ...
    public BiometricSet1 RetriveImage(String staff_id)
    {
     ...
     //Statement stmt = (Statement) con.createStatement();
            //ResultSet rs = statement.executeQuery("SELECT * FROM DB.images");
            //int count = 0;
...
//String sql = "INSERT INTO client_biometric  (client_id,picture_img,sign_img,finger_img) VALUES (?,?,?,?)";
statement =dbconnector.dbconn2.prepareStatement("INSERT INTO client_biometric_infor  (client_id,picture_img,sign_img,finger_img) " + "VALUES (?,?,?,?)");
...
try { 
 ...
 // statement=dbconnector.dbconn .prepareStatement("update client_biometric_infor SET  "+field+"=? where client_id=?");
    statement=dbconnector.dbconn2 .prepareStatement(query,ResultSet.TYPE_FORWARD_ONLY,ResultSet.CONCUR_UPDATABLE);
   //statement.
