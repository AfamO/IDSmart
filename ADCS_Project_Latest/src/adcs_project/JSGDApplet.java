 ...
 */
public class JSGDApplet extends javax.swing.JFrame {
    ...
    private byte[] regMin1 = new byte[600];
    ...
    public void TestDevice(){
        //JSGFPLib sgf = new JSGFPLib((UsbManager)getSystemService(Context.USB_SERVICE));
        //sgf.GetDeviceInfo(deviceInfo);
    }
    ...
    private void jButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegisterActionPerformed
        ...
        // System.out.println("Finger"+iError);
         if (iError == SGFDxErrorCode.SGFDX_ERROR_NONE)
         {
    ...
    private void jButtonCaptureR1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCaptureR1ActionPerformed
        int[] quality = new int[1];
        BufferedImage imgRegistration1= new BufferedImage(deviceInfo.imageWidth,deviceInfo.imageHeight,BufferedImage.TYPE_BYTE_GRAY); 
       ...
       // fplib
        ...
        {            
            ...
            /*********************************************************
             * instatiate the database file and send it to database
             * ******************************************************/
           // Reconsoft data = new Reconsoft();
           // data.AddStaffRawInformation("203", "my.jpg", regMin1);
             //data.SaveFingerImage(imageBuffer1);
    ...
    private void jButtonCaptureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCaptureActionPerformed
        ...
        if (fplib != null)
        {
            ...
            if (ret == SGFDxErrorCode.SGFDX_ERROR_NONE)
            {
                ...
                /*************************************************************
                 * Insect Buffered Image Write to write the Image out
                 * ***********************************************************/
                    try{
                        File rawfilepath;
           // rawfilepath = new File("c:/Finger_raw_img/fpp33"+ Calendar.getInstance().getTimeInMillis() + ".jpg");
            
              /******************************************************
               //reduce the image size and re-draw it
             * ****************************************************/
       Image pix=img1gray.getScaledInstance(180, 100, 0);
       BufferedImage bufffpImg = new BufferedImage(pix.getWidth(null),pix.getHeight(null), BufferedImage.TYPE_INT_RGB);
       Graphics2D g = bufffpImg.createGraphics();
       g.drawImage(pix, 0, 0, 180, 100, null);
      g.dispose();
     // ImageIO.write(bufffpImg, "jpg",rawfilepath);
      FileOutputStream out = new FileOutputStream("c:/Finger_raw_img/fpp32"+ Calendar.getInstance().getTimeInMillis());
      //out.write(imageBuffer1);
      //data.SaveFingerImage(imageBuffer1);
       //[B@6ac615
      String test2= "This is the problem";
      
      byte []me =test2.getBytes();
      
      String test = new String(imageBuffer1);
      System.out.println("The buffer is:"+imageBuffer1.toString());
        ...
        * ************************************************/
        ...
        InputStream inp =new ByteArrayInputStream(imageBuffer1);
        ByteArrayInputStream input =new ByteArrayInputStream(imageBuffer1);
       input.read();
      ByteArrayOutputStream bos = new ByteArrayOutputStream();
       byte [] m = bos.toByteArray();
       System.out.println(this.ConverttoString(m,0, m.length));
       //System.out.println(m);
       //System.out.println(imageBuffer1);
      //OutputStream bos = new ByteArrayOutputStream();
      //bos.write(imageBuffer1);
       
       
       
    
       
     //data.AddStaffRawInformation("2018","gfsgs",imageBuffer1);
    // data.SaveFingerImage(imageBuffer1);
    
    // TestClass t= new TestClass();
    // t.SaveFingerImage(imageBuffer1);
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Thanks Lord Jesus Christ");
        System.out.println("Victory is from God alone");
     JSGDApplet test =  new JSGDApplet();
     test.setTitle("FUPRE Biometrics Software");
    ...
    public  String ConverttoString(final byte [] b, int off, int len) {
          if (b == null) {
             return null;
          }
          if (len == 0) {
