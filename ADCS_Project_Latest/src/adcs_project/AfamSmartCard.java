...
public final class AfamSmartCard {
   ...
   // private static byte INS;
    ...
    final static byte   writeINS2  = (byte) 0xD2;
    //0xA4
    ...
    static byte   DATA1  = (byte) 0xA0;
    static byte   USER_FILE = (byte)0xFF;
     static byte   PERSONALIZE_FILE = (byte)0xFF;
   ...
   public static byte[] hexStringToByteArray(String s) {
        ...
        String data_to_write=byteArrayToHexString(infoTOwrite.getBytes());
         ...
         try{
            if( this.terminal!=null && this.terminal.isCardPresent())
            {
               ...
               // System.out.println("The submitted code in byte IS: "+new Concatenation().ConvertByteToString(val));
           ...
           //r= channel.transmit(new CommandAPDU(0x80,0xD2,0x01,0x00,val));
               //byte [ ] SelectFilecomAPDUBytes = new byte []{CLASS,writeINS2, 0x00, 0x00, 0x06,0x05,0x03,0x00,0x02,USERFiLE,USERid};
                byte [ ] CODESUBcomAPDUBytes = new byte []{CLASS,0x20, 0x07,0x00,0x08,0x41,0x43,0x4F,0x53,0x54,0x45,0x53,0x54};
        ...
        Boolean IsWriiten=false;
         try{
           ...
           //new CommandAPDU(0x80,0xD2,0x01,0x00,val)
                  // 80 D2 00 00 06 05 03 00 00 F0 02
                  // 0x80,0xD2,0x00,0x00,0x06,0x05,0x03,0x00,0x00,0xF0,0x02
           //r= channel.transmit(new CommandAPDU(0x80,0xD2,0x01,0x00,val));80 D2 00 00 04 00 00 03 00
               byte [ ] SelectFilecomAPDUBytes = new byte []{CLASS,writeINS2, 0x00, 0x00, 0x04,0x00,0x00,0x04,0x00};
    ...
    public boolean PersonalizeCard(){
         byte id=(byte)0x04;
        ...
        Boolean IsWriiten=false;
         try{
            if( this.terminal!=null && this.terminal.isCardPresent())
            {
                if(this.SelectFileFromSmartCard(USER_FILE,id) && this.SubmittIC()){
                   CardChannel channel = card1.getBasicChannel();
             
               byte USERFiLE=(byte)0xF0;
                byte USERid=(byte)0x02;
                 byte USERFiLE1=(byte)0xA0;
                byte USERid1=(byte)0x09;
           //new CommandAPDU(0x80,0xD2,0x01,0x00,val)
                  // 80 D2 00 00 06 05 03 00 00 F0 02
                  // 0x80,0xD2,0x00,0x00,0x06,0x05,0x03,0x00,0x00,0xF0,0x02
           //r= channel.transmit(new CommandAPDU(0x80,0xD2,0x01,0x00,val));80 D2 00 00 04 00 00 03 00
               byte [ ] SelectFilecomAPDUBytes = new byte []{CLASS,writeINS2, 0x01, 0x00, 0x06,0x20,0x04,0x00,0x00,USERFiLE,USERid};
           r= channel.transmit(new CommandAPDU(SelectFilecomAPDUBytes));
          //channel.transmit((Buffer)apdu, apdu);
         System.out.println("The response2 to string is: " + r.toString());
          System.out.println("The response2 to Sting() DATA ISSS: " + r.getData().toString());
        ...
        System.out.println("The tHE WhoLE SW is: " + Integer.toHexString(r.getSW()));
         ...
         {
             IsWriiten=true;
             System.out.println("WRITTEN OPERATION ON THE FILE1 WAS SUCCESSFUL" );
             byte [ ] SelectFilecomAPDUBytes1 = new byte []{CLASS,writeINS2, 0x02, 0x00, 0x06,0x20,0x04,0x00,0x00,USERFiLE1,USERid1};
           r= channel.transmit(new CommandAPDU(SelectFilecomAPDUBytes1));
           if(Integer.toHexString(r.getSW()).equals("9000") ||Integer.toHexString(r.getSW()).equals("9102"))
         {
             IsWriiten=true;
            
             System.out.println("WRITTEN OPERATION ON THE FILE2 WAS SUCCESSFUL" );
         }
         else
         {
             IsWriiten=false;
             System.out.println(" WRITTEN OPERATION ON THE FILE2 WAS NOT SUCCESSFUL" );
         }
    ...
    public boolean IsSmartCardFormated_Personalized(){
         byte id=(byte)0x04;
        byte userregfileid=(byte)0x02;
        
        Boolean IsWriiten=false;
         try{
            if( this.terminal!=null && this.terminal.isCardPresent())
            {
                if(this.SelectFileFromSmartCard(DATA,userregfileid)){
                   IsWriiten=true;
                   //JOptionPane.showMessageDialog(null,"pls your card has  been formatted.");
  }
                else
                {
                   System.out.println("pls your card has not been formatted"); 
                   JOptionPane.showMessageDialog(null,"Please your card has not been formatted.");
                }
                }
    ...
    public boolean Format_PersonalizeSmartCard(){
         byte id=(byte)0x04;
        byte userregfileid=(byte)0x02;
        ...
        Boolean IsWriiten=false;
         try{
            if( this.terminal!=null && this.terminal.isCardPresent())
            {
                if(this.SelectFileFromSmartCard(DATA,userregfileid)){
                   IsWriiten=false;
                   JOptionPane.showMessageDialog(null,"Please this card has INITIALLY been formatted .Please insert a new one.\nThank you","ALREADY USED/FORMMATTED",2);
  }
                else if(this.InitializePersonalizationFILE() && this.PersonalizeCard())
                {
                   System.out.println("Please your card has not been formatted"); 
                  // this.WriteToSmartCard(DATA, userregfileid,"AFAMO");
                   IsWriiten=true;
                   JOptionPane.showMessageDialog(null,"Congratulations!!!\n Your smartcard IS NOW  formatted.");
                }
                else 
                {
                    IsWriiten=false;
                   System.out.println("Please your card has not been formatted"); 
                   JOptionPane.showMessageDialog(null,"Please your card can neither be formatted nor personalized\n.Please make sure that it is ACS ACOS3 SmartCard\n And that the card is not damaged");
                   //return;
                }
                }
       ...
       boolean IsFileSelected=false; 
         try{
            if( this.terminal!=null && this.terminal.isCardPresent())
            {
               ...
               //9100
                r=channel.transmit(new CommandAPDU(SelectFilecomAPDUBytes));
                if(Integer.toHexString(r.getSW()).equals("9000") ||Integer.toHexString(r.getSW()).equals("9102")||Integer.toHexString(r.getSW()).equals("9100")||Integer.toHexString(r.getSW()).equals("9101")){
                    System.out.println("FILE selection FOR PERSONLIZE FILE WAS SUCCESSFUL:Status is"+Integer.toHexString(r.getSW()));
                    IsFileSelected=true;
                }
                else if(Integer.toHexString(r.getSW()).equals("6A82") ||Integer.toHexString(r.getSW()).equals("68a2")){
                    System.out.println("FILE NOT FOUND:Status is"+Integer.toHexString(r.getSW()));
                    IsFileSelected=true;
                }
                else
                {
                    System.out.println("FILE selection FOR PERSONLIZE FILE WAS nOt SUCCESSFUL:Status is"+Integer.toHexString(r.getSW()));
        ...
        System.out.println("The tHE WhoLE SW is: " + Integer.toHexString(r.getSW()));
         ...
         else
         {
             ...
             System.out.println("OPERATION ON THE FILE2 WAS NOT SUCCESSFUL" );
                ...
                {
                   System.out.println("FILE2 selection or code sUBmissION WAS nOt SUCCESSFUL:Thus cannot write to it"); 
                }
                }
         else
         {
             ...
             System.out.println("OPERATION ON THE FILE1 WAS NOT SUCCESSFUL" );
                ...
                {
                   System.out.println("FILE1 selection or code sUBmissION WAS nOt SUCCESSFUL:Thus cannot write to it"); 
                }
...
System.out.println(ch);
      ...
      System.out.println("The HexString TO ByteArray of THE  41 43 4F 53 03 01 16 20 IS  " + hexStringToByteArray("ACOSTEST"));
       ...
       byte id=(byte)0x02;
       byte id1=(byte)0x09;
    jsc.WriteToSmartCard(DATA, id,"333");
     //jsc.WriteToSmartCard(DATA1, id1,"donsimon999_@afamokonkwo#healing");
     
      //JOptionPane.showMessageDialog(null,"The INFO was successfully written:");
  String info=jsc.ReadFromSmartCard(DATA, id,9);
    // jsc.ConnectToSmartCard();
    
   
   info=info.substring(0,9);  
  JOptionPane.showMessageDialog(null,"The INFO RED IS:"+info+" and the lent is"+info.length());
     // JOptionPane.showMessageDialog(null,"The byte IS and the lent is"+"donsimon999_@afamokonkwo#healing".getBytes());
       
      //if(jsc.PersonalizeCard()){
         //JOptionPane.showMessageDialog(null,"The personalization of card WAS A SUCCESS:\n");
     // }
      
   // if(jsc.SubmittIC()){
        //  JOptionPane.showMessageDialog(null,"The code SUBMISSION WAS A SUCCESS:\n");
     // }
